            ...
            <div>
                ...
                <div class=" flex items-center justify-between gap-4 mb-4 border-b-2 border-[#8F6B60] p-4 rounded-md">
                    <label for=" numdocbuscar" class="
                     text-[#8F6B60] text-left">
                        Número de documento:
                    </label>
                    <input type="text" id="numdocbuscar" name="numdocbuscar" value="" placeholder="12345678" class=" max-w-32 text-center border border-[#8F6B60] rounded-md p-2  focus:outline-none focus:ring-2 focus:ring-[#8F6B60] focus:border-transparent">
                    <button class="bg-[#EDDFDB] text-[#97847d] border-[#EDDFDB] hover:bg-[#C4B8B5] hover:text-white  hover:border-[#c4b8b5] px-5 py-2 rounded-md ml-2 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-opacity-50
...
<path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708"/>
            ...
            <div class="glide" id="cuponescar">
                <div class="glide__track" data-glide-el="track">
                    ...
                    <div data-glide-el="controls" class="glide__arrows">
                        <button class="glide__arrow glide__arrow--left " data-glide-dir="<"><?php echo $flechaleft ?></button>
                        <button class="glide__arrow glide__arrow--right" data-glide-dir=">"><?php echo $flecharight ?></button>
                    </div>
                </div>
            </div>
            <style>
        ...
        ?> </h3> <?php
                ...
                echo "<button class='bg-[#EDDFDB] text-[#97847d] border-[#EDDFDB] hover:bg-[#C4B8B5] hover:text-white  hover:border-[#c4b8b5] mt-4 block m-auto text-center px-5 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-opacity-50' onclick='eliminarCliente();event.preventDefault();' >Cerrar sessión</button>";
            }
